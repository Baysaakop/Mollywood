                        ...
                        <Meta 
                            ...
                            description={
                                <div style={{ display: 'flex', justifyContent: 'space-between' }}>
                                    <div>{props.date}</div>
                                    <div><StarFilled style={{ color: '#AAF50A', fontSize: '16px' }} />{props.rating}/10</div>
                                </div>
                            } 
                        /> 
                    </Tooltip>                               
                    {/* <div className="content-overlay">        
                        <StarFilled style={{ color: '#AAF50A', fontSize: '24px' }} />            
                        <p style={{ color: 'white', fontSize: '24px' }}>{props.rating}/10</p>                                              
                    </div>                                     */}
                </Card>          
            </Link>  
        </div>
